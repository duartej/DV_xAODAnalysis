...
void DVPlusElectronBasic::bookHists(DV::PlotsManager * plotmanager) 
{
    ...
    m_nPV = plotmanager->bookTH1<TH1F,float>("nPV","nPV",20,-0.5,19.5);
    m_PVx = plotmanager->bookTH1<TH1F,float>("PVx","PVx",100,-2.,2.);
    m_PVy = plotmanager->bookTH1<TH1F,float>("PVy","PVy",100,-2.,2.);
    m_PVxy = plotmanager->bookTH2<TH2F,float>("PVxy","PVxy",50,-2.,2.,50,-2,2);
    m_PVz = plotmanager->bookTH1<TH1F,float>("PVz","PVz",100,-300.,300.);
    m_PVz_zWeighted = plotmanager->bookTH1<TH1F,float>("PVz_zWeighted","PVz",100,-300.,300.);
    m_PVrSpread = plotmanager->bookTH1<TH1F,float>("PVrSpread","PVrSpread",100,0.,1.);
    m_DVmass = plotmanager->bookTH1<TH1F,float>("DVmass","massHist",100,0.,20.);
    m_DVmassPtCorr = plotmanager->bookTH1<TH1F,float>("DVmassPtCorr","massHist",100,0.,20.);
    m_DVmassBig = plotmanager->bookTH1<TH1F,float>("DVmassBig","massHist",100,0.,600.);
    m_DVmassBigPtCorr = plotmanager->bookTH1<TH1F,float>("DVmassBigPtCorr","massHist",100,0.,600.);
    m_DVnTrk = plotmanager->bookTH1<TH1F,float>("DVnTrk","nTrk",15,1.5,16.5);
    m_DVnTrkVsMass = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMass","nTrkVsMass",15,1.5,16.5,100,0.,50.);
    m_DVnTrkVsMassLog = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMassLog","nTrkVsMass",50,1.5,51.5,50,0.,500.);
    m_DVnTrkVsMassLogAllCuts = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMassLogAllCuts","nTrkVsMass",50,1.5,51.5,50,0.,500.);
    m_DVnTrkVsMassLogAllCutsExceptEl = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMassLogAllCutsExceptEl","nTrkVsMass",50,1.5,51.5,50,0.,500.);
    m_DVnTrkVsMassLogAllCutsExceptElMatch = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMassLogAllCutsExceptElMatch","nTrkVsMass",50,1.5,51.5,50,0.,500.);
    m_DVnTrkVsMassLogAllCutsUpToNtrk = plotmanager->bookTH2<TH2F,float>("DVnTrkVsMassLogAllCutsUpToNtrk","nTrkVsMass",50,1.5,51.5,50,0.,500.);
    m_DVrz = plotmanager->bookTH2<TH2F,float>("DVrz","rDV",100,0.,300.,100,0.,180.);
    m_DVxy = plotmanager->bookTH2<TH2F,float>("DVxy","xyDV",400,-200.,200.,400,-200.,200.);
    m_DVxy_KsGamVeto = plotmanager->bookTH2<TH2F,float>("DVxy_KsGamVeto","xyDV",400,-200.,200.,400,-200.,200.);
    m_DVrphi = plotmanager->bookTH2<TH2F,float>("DVrphi","rphi; #phi' r_{DV} [mm]",600,-3.15,3.15,400,0.,200.);
    m_DVrphi_KsGamVeto = plotmanager->bookTH2<TH2F,float>("DVrphi_KsGamVeto","; #phi; r_{DV} [mm]",600,-3.15,3.15,400,0.,200.);
    m_DVr = plotmanager->bookTH1<TH1F,float>("DVr","rDV",100,0.,180.);
    m_DVz = plotmanager->bookTH1<TH1F,float>("DVz","zDV",100,-300.,300.);
    m_averageIntPerXing = plotmanager->bookTH1<TH1F,float>("averageIntPerXing","averageInt",60,0.,30.);
    m_actualIntPerXing = plotmanager->bookTH1<TH1F,float>("actualIntPerXing","averageInt",60,0.,30.);
    m_DVr_GE3Trk = plotmanager->bookTH1<TH1F,float>("DVr_GE3Trk","DVr_GE3Trk",100,0.,180.);
    m_DVnTrk_KsGamVeto = plotmanager->bookTH1<TH1F,float>("DVnTrk_KsGamVeto","DVnTrk",14,0.5,14.5);
    m_pileupWeights = plotmanager->bookTH1<TH1F,float>("pileupWeights","; pileup weights",100,0.,3.);
    m_zpvWeights = plotmanager->bookTH1<TH1F,float>("zpvWeights","; zPV weights",100,0.,3.);
    m_elecWeights = plotmanager->bookTH1<TH1F,float>("elecWeights","; elec weights",100,0.,3.);
